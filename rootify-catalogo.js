...
(function (raiz) {
  ...
  var MODULOS = [
    ...
    /* a Inbox tem lugar fixo no cabeçalho (📥); por isso não aparece no ☰ (oculto) */
    { id: 'inbox', grupo: 'visao', icone: '📥', recurso: 'painel', estado: 'ativo', oculto: true,
      nome: N('Caixa de entrada', 'Inbox'),
      ajuda: N('Tudo o que pede a sua atenção, em ordem de prioridade: prazos de chamados, pedidos de privacidade, aprovações, publicação pendente, e-mails aguardando envio e avisos das automações.',
               'Everything that needs your attention, by priority: ticket deadlines, privacy requests, approvals, pending publication, e-mails waiting to be sent and automation alerts.') },
    ...
    { id: 'recursos', grupo: 'produto', icone: '🎛️', recurso: 'recursos', estado: 'ativo',
      ...
      ajuda: N('O que o mercado chama de feature flags, remote config e CMS headless, num lugar só e por app: ligar e desligar funções, ajustar comportamentos e editar conteúdo (textos, fotos, vídeos do YouTube, links) sem commit. Vira recursos/<app>.json e conteudo/<app>.json (e, para conteúdo tipado como os aparelhos do RiseONE, conteudo/<app>/<tipo>.json).',
    ...
    { id: 'usuarios', grupo: 'clientes', icone: '👥', recurso: 'usuarios', estado: 'parcial',
      ...
      partes: [{ sub: 'lista', nome: N('Todos', 'Everyone') }, { sub: 'segmentos', nome: N('Segmentos', 'Segments') }, { sub: 'importar', nome: N('Importar / exportar', 'Import / export') }],
    ...
    { id: 'suporte', grupo: 'clientes', icone: '🎧', recurso: 'suporte', estado: 'parcial',
      ...
      partes: [{ sub: 'minha', nome: N('Minha fila', 'My queue') }, { sub: 'sem', nome: N('Sem responsável', 'Unassigned') }, { sub: 'risco', nome: N('Prazo em risco', 'Deadline at risk') },
               { sub: 'relatorios', nome: N('Relatórios', 'Reports') }, { sub: 'config', nome: N('Prazos e respostas', 'Deadlines and replies') }],
    ...
    { id: 'termos', grupo: 'conteudo', icone: '📜', recurso: 'termos', estado: 'parcial',
      ...
      partes: [{ sub: 'agente', nome: N('🤖 Agente de políticas', '🤖 Policy agent') }],
    ...
    { id: 'conteudo-apps', grupo: 'produto', icone: '🧱', recurso: 'conteudo', estado: 'ativo', oculto: true,   /* entra pelo Controle dos apps → Conteúdo */
      nome: N('Conteúdo dos apps', 'App content'),
      partes: [{ sub: 'rise-one', nome: N('RiseONE: aparelhos', 'RiseONE: equipment') }],
      ajuda: N('Texto, foto e vídeos do YouTube do que cada app mostra (hoje: aparelhos de academia do RiseONE). Edite aqui e publique; o app lê o conteudo/<app>/….json sem precisar de commit.',
               'Text, photo and YouTube videos of what each app shows (today: RiseONE gym equipment). Edit here and publish; the app reads conteudo/<app>/….json with no commit.') },
    ...
    { id: 'privacidade', grupo: 'governanca', icone: '🔏', recurso: 'privacidade', estado: 'parcial',
      ...
      partes: [{ sub: 'pedidos', nome: N('Pedidos dos titulares', 'Data-subject requests') }, { sub: 'ropa', nome: N('Registro de tratamento', 'Record of processing') },
               { sub: 'consentimentos', nome: N('Consentimentos', 'Consents') }, { sub: 'incidentes', nome: N('Incidentes', 'Incidents') }],
    ...
    { id: 'emails', grupo: 'operacao', icone: '✉️', recurso: 'emails', estado: 'parcial',
      nome: N('E-mails', 'E-mails'),
      partes: [{ sub: 'saida', nome: N('Caixa de saída', 'Outbox') }, { sub: 'modelos', nome: N('Modelos', 'Templates') }, { sub: 'remetentes', nome: N('Remetentes e domínio', 'Senders and domain') }, { sub: 'envio', nome: N('Envio (provedor)', 'Delivery (provider)') }],
      ajuda: N('Tudo o que a plataforma manda por e-mail sai daqui: caixa de saída, modelos PT/EN, remetentes @solverone.com.br e o provedor de envio. Sem servidor, os e-mails ficam prontos na caixa de saída e abrem no seu programa de e-mail; com o proxy configurado, saem sozinhos.',
               'Everything the platform sends by e-mail leaves from here: outbox, PT/EN templates, @solverone.com.br senders and the delivery provider. Without a server, e-mails wait ready in the outbox and open in your mail program; with the proxy configured, they go out on their own.') },
    { id: 'integracoes', grupo: 'operacao', icone: '🔌', recurso: 'integracoes', estado: 'parcial',
      nome: N('Integrações e chaves', 'Integrations and keys'),
      partes: [{ sub: 'dominio', nome: N('Domínio e DNS', 'Domain and DNS') }],
      ajuda: N('GitHub, domínio solverone.com.br, Formspree, política de chaves de IA e os serviços que ainda vão entrar (Firebase, pagamento).',
               'GitHub, the solverone.com.br domain, Formspree, AI key policy and the services still to come (Firebase, payments).') },
    ...
    { id: 'financeiro', grupo: 'operacao', icone: '💰', recurso: 'financeiro', estado: 'parcial',
      ...
      partes: [{ sub: 'custos', nome: N('Custos', 'Costs') }, { sub: 'receita', nome: N('Receita', 'Revenue') }, { sub: 'meios', nome: N('Meios de pagamento', 'Payment methods') }],
  ...
  /* Ações rápidas no topo do ☰ (até 4): o que a equipe mais faz.
     'faz' é o nome de uma função em RF.h (definida pelas telas). */
  var ACOES_RAPIDAS = [
    { id: 'chamado', icone: '🎧', nome: N('Chamado', 'Ticket'), perm: 'suporte:criar', faz: 'novoChamado' },
    { id: 'usuario', icone: '👤', nome: N('Usuário', 'User'), perm: 'usuarios:criar', faz: 'novoUsuario' },
    { id: 'email', icone: '✉️', nome: N('E-mail', 'E-mail'), perm: 'emails:criar', faz: 'novoEmail' },
    { id: 'publicar', icone: '🚀', nome: N('Publicar', 'Publish'), perm: 'publicar:ver', rota: 'publicar' }
  ];
  ...
  var RECURSOS = [
    ...
    { id: 'conteudo', nome: N('Conteúdo dos apps (textos, fotos, vídeos)', 'App content (texts, photos, videos)'), acoes: ['ver', 'criar', 'editar', 'excluir'] },
    ...
    { id: 'emails', nome: N('E-mails (caixa de saída e modelos)', 'E-mails (outbox and templates)'), acoes: ['ver', 'criar', 'editar', 'excluir'] },
    { id: 'emails.config', nome: N('Remetentes, domínio e provedor de e-mail', 'E-mail senders, domain and provider'), acoes: ['editar'] },
  ...
  var PAPEIS = [
    ...
    { id: 'admin-plataforma', cor: '#f97316',
      ...
      permissoes: varias(['apps', 'planos', 'servicos', 'recursos', 'conteudo', 'usuarios', 'usuarios.pii:ver', 'usuarios.conta:editar',
        ...
        'termos:publicar', 'recados', 'anuncios', 'conteudo', 'versoes', 'publicar', 'papeis:ver', 'equipe:ver', 'equipe:criar',
    ...
    { id: 'admin-app', cor: '#eab308', escopoPorApp: true,
      ...
      permissoes: varias(['apps:ver', 'apps:editar', 'servicos', 'recursos', 'conteudo', 'planos:ver', 'usuarios:ver', 'usuarios:editar',
        ...
        'termos:editar', 'recados', 'conteudo', 'versoes', 'publicar:ver', 'automacoes:ver', 'armazenamento:ver', 'emails:ver', 'emails:criar']) },
    { id: 'suporte-n1', cor: '#22c55e', escopoPorApp: true,
      ...
      permissoes: ['apps:ver', 'usuarios:ver', 'suporte:ver', 'suporte:criar', 'suporte:editar', 'kb:ver', 'emails:ver', 'emails:criar'] },
    { id: 'suporte-n2', cor: '#16a34a', escopoPorApp: true,
      ...
      permissoes: varias(['apps:ver', 'usuarios:ver', 'usuarios:editar', 'usuarios.pii:ver', 'usuarios.conta:editar',
        ...
        'privacidade:ver', 'privacidade:criar', 'emails:ver', 'emails:criar', 'emails:editar']) },
    { id: 'sucesso-cliente', cor: '#06b6d4',
      ...
      permissoes: varias(['apps:ver', 'planos:ver', 'usuarios:ver', 'usuarios:editar', 'usuarios:exportar',
        'usuarios.pii:ver', 'suporte:ver', 'kb:ver', 'kb:criar', 'kb:editar', 'recados', 'automacoes:ver', 'emails:ver', 'emails:criar', 'emails:editar']) },
    { id: 'conteudo', cor: '#a855f7',
      ...
      permissoes: varias(['apps:ver', 'termos:ver', 'termos:criar', 'termos:editar', 'recados', 'anuncios', 'conteudo', 'versoes',
        'kb', 'publicar:ver', 'emails:ver', 'emails:editar', 'recursos:ver']) },
    ...
    { id: 'dpo', cor: '#8b5cf6',
      ...
      permissoes: varias(['privacidade', 'termos:ver', 'termos:aprovar', 'termos:publicar', 'usuarios:ver',
        'usuarios:exportar', 'usuarios:excluir', 'usuarios.pii:ver', 'suporte:ver', 'auditoria', 'apps:ver', 'publicar', 'emails:ver', 'emails:criar']) },
  ...
  var FUNCOES = [
    ...
    F('suporte.email', 'suporte', 'futuro', 2, N('Chamados chegando por e-mail', 'Tickets arriving by e-mail'),
      N('O remetente suporte@solverone.com.br já está em E-mails; falta o provedor com recebimento (inbound) e o servidor.', 'The suporte@solverone.com.br sender is already in E-mails; the inbound provider and the server are still missing.')),
    ...
    F('equipe.convite', 'equipe', 'parcial', 1, N('Convite por e-mail', 'E-mail invitation'),
      N('O convite já sai pela caixa de saída (modelo "Convite para a equipe"); a entrega automática depende do provedor de envio.', 'The invitation already leaves through the outbox ("Team invitation" template); automatic delivery depends on the delivery provider.')),
    ...
    F('emails.saida', 'emails', 'ativo', 1, N('Caixa de saída: e-mails prontos, abertos no programa local ou copiados', 'Outbox: e-mails ready, opened in the local mail program or copied')),
    F('emails.modelos', 'emails', 'ativo', 1, N('Modelos PT/EN com campos {nome}, {app}, {link}…', 'PT/EN templates with {nome}, {app}, {link}… fields')),
    F('emails.remetentes', 'emails', 'ativo', 1, N('Remetentes @solverone.com.br e lista de DNS (SPF, DKIM, DMARC)', '@solverone.com.br senders and DNS checklist (SPF, DKIM, DMARC)')),
    F('emails.envio', 'emails', 'futuro', 2, N('Envio automático pelo provedor', 'Automatic delivery through the provider'),
      N('Escolher o provedor (Resend, Brevo, SES…) e publicar o proxy (Cloudflare Worker ou Firebase Function) que guarda a chave. O RootifyONE já manda para o endereço do proxy quando ele existir.',
        'Choose the provider (Resend, Brevo, SES…) and publish the proxy (Cloudflare Worker or Firebase Function) that keeps the key. RootifyONE already posts to the proxy address once it exists.')),
    F('emails.recebimento', 'emails', 'futuro', 2, N('Receber respostas e virar chamado', 'Receive replies and turn them into tickets'),
      N('Depende do provedor com webhook de entrada (inbound) e do servidor.', 'Depends on a provider with inbound webhook and on the server.')),
    F('integracoes.dominio', 'integracoes', 'ativo', 1, N('Domínio solverone.com.br: registros de DNS e conferência dos endereços', 'solverone.com.br domain: DNS records and address check')),
    ...
    F('automacoes.email', 'automacoes', 'parcial', 1, N('Ação "enviar e-mail" (vai para a caixa de saída)', '"Send e-mail" action (goes to the outbox)'),
      N('A regra já cria o e-mail na caixa de saída com o modelo escolhido; sair sozinho depende do provedor de envio.', 'The rule already creates the e-mail in the outbox with the chosen template; leaving on its own depends on the delivery provider.')),
    ...
    F('config.assistone', 'configuracoes', 'ativo', 1, N('AssistONE: ajuda da tela, tour, busca e passo a passo', 'AssistONE: screen help, tour, search and walkthrough')),
    F('config.barra', 'configuracoes', 'ativo', 1, N('Barra de atalhos montada por arrastar e soltar (ou por toque)', 'Shortcut bar built by drag and drop (or by tap)'))
  ];

  /* ------------------------------------------------------------------
     6. DADOS INICIAIS
     ------------------------------------------------------------------ */
  /* Domínio da plataforma (decisão de 25/Set/2026): um domínio, apps em pastas.
     O endereço antigo continua valendo como reserva (o GitHub Pages redireciona). */
  var DOMINIO = { atual: 'https://solverone.com.br/', antigo: 'https://marceloneco.github.io/', dados: 'solverone-dados' };

  var APPS = [
    { id: 'portal', nome: N('Portal de Projetos', 'Projects Portal'), repo: 'marceloneco.github.io',
      url: 'https://solverone.com.br/', estado: 'beta', cor: '#60a5fa', glifo: '🧭',
    ...
    { id: 'rootify-one', nome: N('RootifyONE', 'RootifyONE'), repo: 'rootify-one',
      url: 'https://solverone.com.br/rootify-one/', estado: 'alpha', cor: '#f87171', glifo: '🌳',
    ...
    { id: 'feature-tester', nome: N('Feature Tester', 'Feature Tester'), repo: 'FeatureTesting',
      url: 'https://solverone.com.br/FeatureTesting/', estado: 'beta', cor: '#fbbf24', glifo: '🧪',
    ...
    { id: 'omnilife-one', nome: N('OmniLifeONE', 'OmniLifeONE'), repo: 'omnilife-one',
      url: 'https://solverone.com.br/omnilife-one/', estado: 'beta', cor: '#e4a460', glifo: '🧩',
    ...
    { id: 'moneytrio', nome: N('MoneyTRIO', 'MoneyTRIO'), repo: 'investify-me',
      url: 'https://solverone.com.br/investify-me/', estado: 'beta', cor: '#d6a076', glifo: '💰',
    ...
    { id: 'rise-one', nome: N('RiseONE', 'RiseONE'), repo: 'rise-one',
      url: 'https://solverone.com.br/rise-one/', estado: 'beta', cor: '#beb0ec', glifo: '🏃',
    ...
    { id: 'eleicoes-2026', nome: N('Eleições 2026', '2026 Elections'), repo: 'planos-candidatos-2026',
      url: 'https://solverone.com.br/planos-candidatos-2026/', estado: 'beta', cor: '#a4c4a6', glifo: '🗳️',
    ...
    { id: 'contador-de-historias', nome: N('Contador de Histórias', 'Storyteller'), repo: 'contador-de-historias',
      url: 'https://solverone.com.br/contador-de-historias/', estado: 'beta', cor: '#96c0e8', glifo: '📖',
    ...
    { id: 'cifras-violao', nome: N('CifrasONE', 'CifrasONE'), repo: 'cifras-violao',
      url: 'https://solverone.com.br/cifras-violao/', estado: 'beta', cor: '#eaa4b8', glifo: '🎸',
  ...
  /* coleções genéricas iniciais: nenhuma. Os aparelhos do RiseONE têm editor próprio (rootify-conteudo.js). */
